        ...
        <section className='container-fluid container-xl px-5 rounded'>
            ...
            <div className='pb-5 mt-5'>
                <div className='pb-5 border-bottom'>
                    ...
                    <img className='mt-5 img-custom' src='./load_image?type=static&name=works1.png' alt='works1'/>
                ...
                <div className='py-5 border-bottom'>
                    ...
                    <div className='row'>
                        <div className='col-lg-5 mt-5'>
                            <img className='img-custom-grid' src='./load_image?type=static&name=works2.jpg' alt='works2'/>
                        </div>
                        <div className='col-lg-5 mt-5'>
                            <img className='img-custom-grid' src='./load_image?type=static&name=works3.jpg' alt='works3'/>
                        </div>
                        <div className='col-lg-5 mt-5'>
                            <img className='img-custom-grid' src='./load_image?type=static&name=works4.jpg' alt='works4'/>
                        </div>
                        <div className='col-lg-5 mt-5'>
                            <img className='img-custom-grid' src='./load_image?type=static&name=works5.jpg' alt='works5'/>
                        </div>
                        <div className='col-lg-5 mt-5'>
                            <img className='img-custom-grid' src='./load_image?type=static&name=works6.jpg' alt='works6'/>
                        </div>
                        <div className='col-lg-5 mt-5'>
                            <img className='img-custom-grid' src='./load_image?type=static&name=works7.jpg' alt='works7'/>
                        </div>
                    </div>
