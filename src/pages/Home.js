        ...
        <div className='container-fluid container-xl'>
            ...
            <section className='pt-5 pb-5 mt-4 rounded'>
                ...
                <div className='border-top mx-4 mt-5 py-3'>
                    <h4 className='float-end me-3 fst-italic'><Link className='text-dark opacity-75' to={'/contact'}>Contact<svg className='ms-1' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M19.1642 12L12.9571 5.79291L11.5429 7.20712L16.3358 12L11.5429 16.7929L12.9571 18.2071L19.1642 12ZM13.5143 12L7.30722 5.79291L5.89301 7.20712L10.6859 12L5.89301 16.7929L7.30722 18.2071L13.5143 12Z"/></svg></Link></h4>
                </div>
            </section>
        </div>
    );
